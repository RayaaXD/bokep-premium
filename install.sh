...
export GITHUB_BASE_URL="https://raw.githubusercontent.com/RayaaXD/bokep-premium"
export RAYA_MODZ="https://github.com/RayaaXD/bokep-premium"
...
update_lib_source() {
  ...
  if ! curl -sSL "$RAYA_MODZ/lib/lib.sh" -o /tmp/lib.sh; then
